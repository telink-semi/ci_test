...
int tlkapp_init(void)
{
	...
	tlkapp_irq_init();
	gpio_function_en(GPIO_PD5);
	gpio_output_en(GPIO_PD5);
	gpio_set_low_level(GPIO_PD5);
	gpio_function_en(GPIO_PD4);
	gpio_output_en(GPIO_PD4);
	gpio_set_low_level(GPIO_PD4);
	tlk_dbgio_init();
	tlkcfg_load();
